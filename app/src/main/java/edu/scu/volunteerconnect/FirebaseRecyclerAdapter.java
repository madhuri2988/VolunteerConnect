...
/**
 * Created by MadhuriKambalapalli on 2/17/16.
 */
...
String category;
     ...
     */
    public FirebaseRecyclerAdapter(Query query, Class<T> itemClass,String c) {
        this(query, itemClass, null, null,c);
    }
    ...
    public FirebaseRecyclerAdapter(Query query, Class<T> itemClass,
                                   ...
                                   @Nullable ArrayList<String> keys,String c) {
        this.mQuery = query;
        this.category=c;
        ...
        public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
            ...
            if (!mKeys.contains(key)) {
                ...
                try {
                    ...
                    date2 = formatter.parse(e.getDate());
                } catch (ParseException e1) {
                    e1.printStackTrace();
                }


                if (date1.compareTo(date2) > 0 && e.getCategory().trim().equals(category.trim())) {
